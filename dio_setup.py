#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe data_io.py -W setup.py
...
data_io = Target(
    ...
    script="data_io.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'data_io'
    # dest_base = "data_io",

    # Icon resources:[(resource_id, path to .ico file), ...]
    icon_resources=[(1, r"hx.ico")],

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="data_io", level="asInvoker")).encode("utf-8")),
...
setup(name="LabView Data Parser",
