...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lorentzian_radio_button.setToolTipDuration(3)
        self.lorentzian_radio_button.setChecked(True)
        ...
        self.gridLayout_2.addWidget(self.data_mean_wavelength_pm_spin_box, 3, 2, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.groupBox_5)
        self.label_3.setObjectName("label_3")
        self.gridLayout_2.addWidget(self.label_3, 1, 0, 1, 1)
        self.data_spectral_width_pm_spin_box = QtWidgets.QDoubleSpinBox(self.groupBox_5)
        self.data_spectral_width_pm_spin_box.setDecimals(5)
        self.data_spectral_width_pm_spin_box.setMaximum(99999999999.0)
        self.data_spectral_width_pm_spin_box.setObjectName("data_spectral_width_pm_spin_box")
        self.gridLayout_2.addWidget(self.data_spectral_width_pm_spin_box, 1, 2, 1, 1)
        self.data_spectral_width_spin_box = QtWidgets.QDoubleSpinBox(self.groupBox_5)
        self.data_spectral_width_spin_box.setDecimals(5)
        self.data_spectral_width_spin_box.setMaximum(99999999999.0)
        self.data_spectral_width_spin_box.setObjectName("data_spectral_width_spin_box")
        self.gridLayout_2.addWidget(self.data_spectral_width_spin_box, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.data_mean_wavelength_spin_box, 3, 1, 1, 1)
        ...
        self.doubleSpinBox_2.setMaximum(99999999999.0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "Sigma/gamma"))
        ...
        self.data_spectral_width_pm_spin_box.setPrefix(_translate("MainWindow", "± "))
        ...
        self.doubleSpinBox.setSuffix(_translate("MainWindow", " THz"))
